...
function create({ leaders }) {
    ...
    try {
      ...
      if (image) {
        ...
        const res = await axios.post(
          "https://api.cloudinary.com/v1_1/dcscznqix/image/upload",
          data
        );
  ...
  return (
    <div className="flex bg-black">
      ...
      {isuplaoding ? (
        <div className="mx-auto md:mr-20 min-[840px]:mr-32 lg:mx-auto flex items-center justify-center min-h-screen bg-black">
          4
          <div className="p-8 rounded-lg  w-full max-w-md">
            <h1 className="text-4xl font-sans font-extrabold mb-4 text-center text-purple-400">
              Uploading Meme
            </h1>
