...
export default function Page() {
  ...
  const fetchData = async () => {
    try {
      const response = await axios.get(
        `${process.env.NEXT_PUBLIC_API_URL}/post/get`
      );
  ...
  const fetchDataLeader = async () => {
    await axios
      .get(`${process.env.NEXT_PUBLIC_API_URL}/leaderboard/top/10`)
      .then((response) => {
  ...
  const handleCommentSubmit = (
    ...
    axios
      .post(
        `${process.env.NEXT_PUBLIC_API_URL}/post/comment/${id}`,
        { Description: comment },
        {
          headers: headers,
        }
  ...
  const handleUpvote = (
    ...
    axios
      .post(
        `${process.env.NEXT_PUBLIC_API_URL}/post/upvote/${id}`,
        {},
        {
          headers: headers,
        }
