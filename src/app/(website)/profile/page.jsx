          ...
          <div className="text-center border-b border-gray-300 pb-5 mb-5">
            ...
            <div className="flex justify-center gap-4 mt-4">
              <span className="text-gray-400">
                ...
                {profile.NumberOfPosts == 1 ? " Post" : " Posts"}
              </span>
              <span className="text-gray-400">
                {profile.NumberofUpvotes}
                {profile.NumberofUpvotes == 1 ? " Upvotes" : " Upvotes"}
              </span>
            </div>
            {isMobile && (
              <div className="flex justify-center mt-4">
                <LogOut
                  className="w-6 h-6 text-center text-white cursor-pointer"
                  onClick={() => {
                    localStorage.removeItem("token");
                    window.location.reload();
                  }}
          ...
          {profile.posts &&
            profile.posts.map((post) => (
              ...
              >
                ...
                <span className="font-semibold text-white mt-5 text-center w-32 text-wrap ">
                  {post.Image
                    ? truncateString(post.Title, 15)
